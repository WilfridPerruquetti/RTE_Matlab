...
print -dpdf -painters Estim1Step
cleanfigure;
matlab2tikz('Estim1Step.tex','width','\figwidth','height','\figheight','showInfo',false);
...
figure(7)
plot(t,ys-yestim2)
R2estim2=1 - sum((ys - yestim2).^2)/sum((y - mean(y)).^2);
disp(['R^2 (estim2)=',num2str(R2estim2)]);
%R2 = 0.82363 (not very good
figure(8)
...
plot(t,ys,t,y_sim)
R2estim3=1 - sum((ys - y_sim).^2)/sum((y - mean(y)).^2);
