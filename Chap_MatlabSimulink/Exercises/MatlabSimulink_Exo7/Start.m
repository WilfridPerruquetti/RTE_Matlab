...
legend('$x(t)$','$v(t)=\frac{dx}{dt}(t)$','Interpreter','latex','Location','best')
...
print -dpdf -painters FigureControlledMobileRobotCont

cleanfigure;
matlab2tikz('FigureControlledMobileRobotCont.tex','width','\figwidth','height','\figheight','showInfo',false);
...
set(gcf,...
    'PaperPosition',[0 0 screenposition(3:4)],...
    'PaperSize',[screenposition(3:4)]);
print -dpdf -painters FigureControlledMobileRobotDisc

cleanfigure;
matlab2tikz('FigureControlledMobileRobotDisc.tex','width','\figwidth','height','\figheight','showInfo',false);
